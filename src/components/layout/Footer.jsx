      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: isMobile ? "40px 16px 24px" : "56px 24px 40px" }}>
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ fontSize: 13, lineHeight: 1.7, color: theme.grayLight, marginBottom: 20, maxWidth: 260 }}>
            ...
            <div style={{ marginBottom: 20 }}>
              <div style={{
                fontSize: 12, fontWeight: 600, color: theme.grayMuted,
              ...
              <div style={{ display: "flex", gap: 6 }}>
                <input type="email" placeholder="your@email.com" style={{
                  ...
                  borderRadius: 8, color: theme.white, fontSize: 13,
            ...
            <div style={{ display: "flex", gap: 8 }}>
              {[{ icon: "f", label: "Facebook" }, { icon: "in", label: "LinkedIn" }, { icon: "tw", label: "Twitter" }, { icon: "yt", label: "YouTube" }].map((s) => (
                <div key={s.label} title={s.label} style={{
                  ...
                  color: theme.grayMuted, transition: "all 0.15s",
                }}
          ...
          {/* On mobile: show tools in 2 columns side by side */}
          {isMobile ? (
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
              {/* Quick Tools */}
              <div>
                <h4 style={{ color: theme.white, fontWeight: 700, marginBottom: 12, fontSize: 13, textTransform: "uppercase", letterSpacing: "0.6px" }}>
                  Quick Tools
                </h4>
                {CALCULATORS.slice(0, 4).map((c) => (
                  <button key={c.id} onClick={() => navigate(c.href)} style={{
                    ...
                    fontSize: 13, padding: "5px 0", cursor: "pointer",
          ...
          <div>
            ...
            {["About Us", "Contact Us", "Privacy Policy", "Terms of Service", "Careers", "Blog"].map((l) => (
              <div key={l} style={{
                color: theme.grayLight, fontSize: 13, padding: "5px 0",
            ...
            <div style={{ marginTop: 20 }}>
              ...
              <div style={{ fontSize: 13, color: theme.grayLight, lineHeight: 1.8 }}>
        ...
        <div style={{
          background: theme.navyLight, border: `1px solid ${theme.border}`,
          borderRadius: 12, padding: isMobile ? "16px" : "20px 28px",
          display: "flex", justifyContent: "space-around",
          flexWrap: "wrap", gap: 16, marginBottom: 32,
        }}>
          {[["8+", "Free Tools Available"], ["100%", "No Sign-up Required"], ["4", "Marketplaces Covered"], ["Real-time", "Live Calculations"], ["₹0", "Always Free"]].map(([n, l]) => (
            <div key={l} style={{ textAlign: "center" }}>
              <div style={{ fontSize: isMobile ? 16 : 20, fontWeight: 800, color: theme.teal, marginBottom: 2 }}>{n}</div>
        ...
        <div style={{
          ...
          <p style={{ fontSize: 13, color: theme.grayMuted }}>© 2025 BaazarIQ. All rights reserved.</p>
          <div style={{ display: "flex", gap: isMobile ? 12 : 20, flexWrap: "wrap" }}>
            {["Privacy Policy", "Terms of Service", "Sitemap"].map((l) => (
              <span key={l} style={{ fontSize: 12, color: theme.grayMuted, cursor: "pointer", transition: "color 0.15s" }}
                onMouseEnter={(e) => (e.target.style.color = theme.teal)}
                onMouseLeave={(e) => (e.target.style.color = theme.grayMuted)}
              >{l}</span>
            ))}
          </div>
          <p style={{ fontSize: 13, color: theme.grayMuted }}>Made with ❤️ for Indian sellers 🇮🇳</p>
        </div>
      </div>
    </footer>
  );
